...
object BotResponse {
    private var ahsp: String? = null
    var ahsf: String? = null
    var ansf: String? = null
    var rnif: String? = null
    var rnsp: String? = null
    ...
    fun basicResponses(_message: String): String {
        ...
        if (ahsp != null) {
            return "제가 분석해본 결과..다른 사람보다 월경을 조금 더 유난스럽게 겪는 사람이군요"
        } else if (ahsf != null) {
            return "활동적인 라이프스타일과 민감한 피부 타입에 꼭 맞는 체내형 월경 용품 추천이 필요한 사람이군요"
        } else if (ansf != null) {
            return "월경 기간에는 평소와 달리 활동적인 라이프스타일을 유지하기 힘든 사람이군요"
        } else if (rnif != null) {
            return "정적인 라이프스타일을 유지하고, 조금은 고통에서 자유로운 사람이군요"
        } else if (rnsp != null) {
            return "민감한 피부에 월경통까지, 정적인 라이프스타일을 유지할 수 밖에 없는 사람이군요"
        } else {
            return when {
                message.contains("안녕") -> {
                    when (random) {
